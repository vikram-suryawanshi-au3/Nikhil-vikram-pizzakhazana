          ...
          <div className="container">
                ...
                <div className="row pt-5 mb-3 text-center d-flex justify-content-center">
                    ...
                    <div className="col-md-2 mb-3">
                        <h6 className="title font-bold"><Link to="/aboutus">About us</Link></h6>
                    </div>
                  
                    <div className="col-md-2 mb-3">
                        <h6 className="title font-bold"><Link to="/menu">Products</Link></h6>
                    </div>
                  
                    <div className="col-md-2 mb-3">
                        <h6 className="title font-bold"><Link to="/contactus">Contact</Link></h6>
                    </div>
